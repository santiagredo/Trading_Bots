...
use crate::controller::{
    delete_action, delete_asset, delete_error_log, delete_indicator, delete_integration_log,
    delete_strategy, get_account, get_action, get_actions, get_asset, get_assets,
    get_engine_status, get_indicator, get_indicators, get_integrations, get_integrations_settings,
    get_metric, get_pair, get_pairs, get_runtimes_status, get_strategies, get_strategy,
    get_subscribed_indicators, get_tasks, get_websocket_status, insert_action, insert_asset,
    ...
    select_configuration, select_error_log, select_error_logs, select_health_check,
    select_indicator, select_indicators, select_integration_log, select_integration_logs,
...
pub fn routes_config(cfg: &mut web::ServiceConfig) {
    ...
    .service(
        web::scope("/error_log")
            .service(select_error_logs)
            .service(select_error_log)
            .service(delete_error_log),
    )
    .service(
        web::scope("/integration_log")
            .service(select_integration_logs)
            .service(select_integration_log)
            .service(delete_integration_log),
    )
    .service(
    ...
    .service(web::scope("/websocket_streams").service(get_websocket_status));
}
